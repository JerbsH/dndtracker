...
export default function Home() {
  return (
    <div className="flex flex-row flex-1 items-center justify-center font-sans gap-4 bg-[url(https://cdn.pixabay.com/photo/2022/11/23/10/26/mountains-7611804_1280.jpg)] bg-cover">
      ...
      <Card className="h-105 w-1/2 max-w-md mx-2 hover:shadow-xl hover:scale-105">
        <img
        ...
        <CardHeader>
          ...
          <CardDescription>
            WIP system to easily manage and view turn amount, player conditions
            and condition length, initiative, player stats and monsters
          </CardDescription>
        </CardHeader>
      </Card>
      <Card className="h-105 w-1/2 max-w-md mx-2 hover:shadow-xl hover:scale-105">
